...
public class teste2A extends JFrame {
	...
	public teste2A() {
		...
		lblNewLabel.setIcon(new ImageIcon(teste2.class.getResource("/img/alarm.png")));
		panel.add(lblNewLabel, "flowx,cell 0 1");
		
		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(teste2.class.getResource("/routinehacker/ROUTINE HACKER.png")));
